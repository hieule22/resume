...
\urlstyle{same}\url{github.com/hieule22} |
\urlstyle{same}\url{linkedin.com/in/hieule16} |
\urlstyle{same}\url{hieule22.github.io} \\ 
...
\descript{| C++ \textbullet{} Python \textbullet{} Protocol Buffers}
